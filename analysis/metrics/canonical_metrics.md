...
- `esmc6b_3di_struct32` (test_drift=0.0000, trusted=True)
- `esmc6b_3di_widehead` (test_drift=0.0000, trusted=True)
- `esmc6b_3di_zeroctrl` (test_drift=0.0000, trusted=True)
...
- `train_run_3di_only` (test_drift=None, trusted=True)
