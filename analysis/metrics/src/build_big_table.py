...
LABELS = {
    ...
    "esmc6b_3di_zeroctrl": "ESM-C 6B ⊕ 3Di gated + boundary (3Di обнулён — контроль)",
    "esmc6b_3di_widehead": "ESM-C 6B ⊕ 3Di gated + boundary (широкая голова: filters64/hidden128)",
    "esmc6b_3di_struct32": "ESM-C 6B ⊕ 3Di gated + boundary (struct_proj 32)",
    "esmc6b_3di_seed1": "ESM-C 6B ⊕ 3Di gated + boundary (seed=1)",
    "esmc6b_3di_seed2": "ESM-C 6B ⊕ 3Di gated + boundary (seed=2)",
