    ...
    for identifier, seq in tqdm(seqs.items()):
        ...
        try:
            ...
            if embedding is None:
                print(f"Skipping {identifier} - sequence too long (>2048 tokens)")
                skipped += 1
                continue
            ...
            skipped += 1
            continue
    print(f"Processing complete. Skipped {skipped} sequences due to length or errors.")
    # return outputs
